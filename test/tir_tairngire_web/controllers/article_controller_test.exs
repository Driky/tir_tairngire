defmodule TirTairngireWeb.ArticleControllerTest do
  use TirTairngireWeb.ConnCase

  alias TirTairngire.Blog
  alias TirTairngire.Blog.Article

  @create_attrs %{body: "some body", description: "some description", slug: "some slug", title: "some title"}
